...
- [x] Julian Day Number (Chapter 7)
- [x] Calendar conversions (Chapter 7)
- [x] Delta-T / Dynamical Time (Chapter 10)
- [x] Mean Sidereal Time (Chapter 12)
- [x] Coordinate Transforms — RA/Dec ↔ Degrees (Chapter 13)
- [x] Moon Position (Chapter 47)
- [x] Annual Stellar Aberration (Chapter 23)

## Future Work

- [x] Nutation (Chapter 22)
- [ ] Sun position (Chapter 25)
- [ ] Precession (Chapter 21)
- [ ] Apparent place of a star (combining aberration, nutation, precession)
- [ ] Rise / Set / Transit times (Chapter 15)
- [ ] Planetary positions
=======
